...
public class SawTileEntity extends BlockBreakingKineticTileEntity {
	...
	public void start(ItemCooldownManager inserted) {
		...
		Ingredient<?> recipe = recipes.get(recipeIndex);
		if (recipe instanceof com.simibubi.create.content.contraptions.components.saw.CuttingRecipe) {
			time = ((com.simibubi.create.content.contraptions.components.saw.CuttingRecipe) recipe).getProcessingDuration();
		}
