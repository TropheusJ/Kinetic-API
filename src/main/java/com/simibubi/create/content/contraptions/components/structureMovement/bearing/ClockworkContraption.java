...
public class ClockworkContraption extends Contraption {
	...
	public static Pair<ClockworkContraption, ClockworkContraption> assembleClockworkAt(GameMode world, BlockPos pos,
		Direction direction) {
		int hourArmBlocks = 0;
	...
	@Override
	public boolean searchMovedStructure(GameMode world, BlockPos pos, Direction direction) {
		return super.searchMovedStructure(world, pos.offset(direction, offset + 1), null);
	}

	@Override
	protected boolean moveBlock(GameMode world, BlockPos pos, Direction direction, List<BlockPos> frontier,
