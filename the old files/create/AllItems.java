...
import static com.simibubi.kinetic_api.AllTags.forgeItemTag;
import static com.simibubi.kinetic_api.AllTags.AllItemTags.CREATE_INGOTS;
import static com.simibubi.kinetic_api.AllTags.AllItemTags.CRUSHED_ORES;
import static com.simibubi.kinetic_api.AllTags.AllItemTags.NUGGETS;
import static com.simibubi.kinetic_api.AllTags.AllItemTags.PLATES;
import static com.simibubi.kinetic_api.content.AllSections.CURIOSITIES;
import static com.simibubi.kinetic_api.content.AllSections.KINETICS;
import static com.simibubi.kinetic_api.content.AllSections.LOGISTICS;
import static com.simibubi.kinetic_api.content.AllSections.MATERIALS;
import static com.simibubi.kinetic_api.content.AllSections.SCHEMATICS;

import bhw;
import com.simibubi.kinetic_api.AllTags.AllItemTags;
import com.simibubi.kinetic_api.content.contraptions.components.structureMovement.glue.SuperGlueItem;
import com.simibubi.kinetic_api.content.contraptions.components.structureMovement.mounted.MinecartContraptionItem;
import com.simibubi.kinetic_api.content.contraptions.components.structureMovement.train.MinecartCouplingItem;
...
import com.simibubi.kinetic_api.content.contraptions.relays.gearbox.VerticalGearboxItem;
import com.simibubi.kinetic_api.content.contraptions.wrench.WrenchItem;
import com.simibubi.kinetic_api.content.contraptions.wrench.WrenchModel;
import com.simibubi.kinetic_api.content.curiosities.BuildersTeaItem;
import com.simibubi.kinetic_api.content.curiosities.ChromaticCompoundColor;
import com.simibubi.kinetic_api.content.curiosities.ChromaticCompoundItem;
import com.simibubi.kinetic_api.content.curiosities.CombustibleItem;
import com.simibubi.kinetic_api.content.curiosities.RefinedRadianceItem;
import com.simibubi.kinetic_api.content.curiosities.ShadowSteelItem;
import com.simibubi.kinetic_api.content.curiosities.TreeFertilizerItem;
import com.simibubi.kinetic_api.content.curiosities.symmetry.SymmetryWandItem;
import com.simibubi.kinetic_api.content.curiosities.symmetry.client.SymmetryWandModel;
import com.simibubi.kinetic_api.content.curiosities.tools.DeforesterItem;
import com.simibubi.kinetic_api.content.curiosities.tools.DeforesterModel;
import com.simibubi.kinetic_api.content.curiosities.tools.ExtendoGripItem;
import com.simibubi.kinetic_api.content.curiosities.tools.ExtendoGripModel;
import com.simibubi.kinetic_api.content.curiosities.tools.SandPaperItem;
import com.simibubi.kinetic_api.content.curiosities.tools.SandPaperItemRenderer.SandPaperModel;
import com.simibubi.kinetic_api.content.curiosities.zapper.blockzapper.BlockzapperItem;
import com.simibubi.kinetic_api.content.curiosities.zapper.blockzapper.BlockzapperModel;
import com.simibubi.kinetic_api.content.curiosities.zapper.terrainzapper.WorldshaperItem;
import com.simibubi.kinetic_api.content.curiosities.zapper.terrainzapper.WorldshaperModel;
import com.simibubi.kinetic_api.content.logistics.item.filter.FilterItem;
import com.simibubi.kinetic_api.content.schematics.item.SchematicAndQuillItem;
...
import com.simibubi.kinetic_api.foundation.item.HiddenIngredientItem;
import com.simibubi.kinetic_api.foundation.item.TagDependentIngredientItem;
...
public class AllItems {
	...
	public static final ItemEntry<HoeItem> COPPER_NUGGET =
	...
	public static final ItemEntry<HoeItem> ANDESITE_ALLOY = ingredient("andesite_alloy"),
	...
	public static final ItemEntry<HoeItem> BAR_OF_CHOCOLATE = REGISTRATE.item("bar_of_chocolate", HoeItem::new)
		.properties(p -> p.a(new bhw.a().a(5)
			.a(0.6F)
			.d()))
	...
	public static final ItemEntry<HoeItem>
	...
	public static final ItemEntry<HoeItem> EMPTY_SCHEMATIC = REGISTRATE.item("empty_schematic", HoeItem::new)
		.properties(p -> p.a(1))
		.register();
	...
	private static ItemEntry<HoeItem> ingredient(String name) {
		return REGISTRATE.item(name, HoeItem::new)
			.register();
	}
	...
	@SafeVarargs
	private static ItemEntry<HoeItem> taggedIngredient(String name, RequiredTagList.e<HoeItem>... tags) {
		return REGISTRATE.item(name, HoeItem::new)
			.tag(tags)
			.register();
	}
