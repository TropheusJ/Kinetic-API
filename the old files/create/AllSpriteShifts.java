...
import static com.simibubi.kinetic_api.foundation.block.connected.CTSpriteShifter.getCT;
import static com.simibubi.kinetic_api.foundation.block.connected.CTSpriteShifter.CTType.HORIZONTAL;
import static com.simibubi.kinetic_api.foundation.block.connected.CTSpriteShifter.CTType.OMNIDIRECTIONAL;
import static com.simibubi.kinetic_api.foundation.block.connected.CTSpriteShifter.CTType.VERTICAL;

import java.util.IdentityHashMap;
import java.util.Map;
import net.minecraft.block.enums.StairShape;
import com.simibubi.kinetic_api.content.palettes.PaletteBlockPatterns;
import com.simibubi.kinetic_api.content.palettes.PaletteBlockPatterns.CTs;
import com.simibubi.kinetic_api.content.palettes.PaletteStoneVariants;
...
public class AllSpriteShifts {
	...
	static final Map<StairShape, CTSpriteShiftEntry> 
	...
	public static CTSpriteShiftEntry getWoodenWindow(StairShape woodType) {
	...
	private static void populateMaps() {
		StairShape.a()
			.forEach(woodType -> WOODEN_WINDOWS.put(woodType, vertical("palettes/" + woodType.b() + "_window")));
